...
public:	
	...
	/*!
	 *  Returns true if the decimalNumberAsString is valid decimal - contains only digits.
	 *
	...
	/*!
	 *  Returns true if the hexNumberAsString is valid hex - contains only digits and capital 
	 *	latin letters from A to F.
	 *
